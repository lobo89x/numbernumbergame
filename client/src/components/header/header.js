...
//client\src\images\astro2.png   client\src\images\astro2.png
  render(){
    return (
      <Navbar bg="dark" variant="dark">
        <img src= {require("../../../src/images/astro2.png")} style={{height:"45px", width:"45px", background:"hidden"}} alt="logo"></img>
